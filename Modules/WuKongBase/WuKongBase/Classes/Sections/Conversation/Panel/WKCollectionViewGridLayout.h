...
/// Project version number for WKCollectionViewGridLayout.
FOUNDATION_EXPORT double WKCollectionViewGridLayoutVersionNumber;

/// Project version string for WKCollectionViewGridLayout.
FOUNDATION_EXPORT const unsigned char WKCollectionViewGridLayoutVersionString[];

@interface WKCollectionViewGridLayout : UICollectionViewLayout
...
@interface WKCollectionViewGridLayout (WKCollectionViewGridLayout_Deprecated)
