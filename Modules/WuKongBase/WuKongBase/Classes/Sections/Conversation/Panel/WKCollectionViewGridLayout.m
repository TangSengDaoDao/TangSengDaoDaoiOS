...
@interface WKCollectionViewGridLayout ()
...
@implementation WKCollectionViewGridLayout
...
@interface WKCollectionViewGridLayout (InspectableScrolling)

@property (nonatomic, assign) IBInspectable BOOL verticalScrolling;

@end

@implementation WKCollectionViewGridLayout (InspectableScrolling)
...
@implementation WKCollectionViewGridLayout (WKCollectionViewGridLayout_Deprecated)
