...
@interface WKVideoBrowseActionSlider : UISlider
@end
@implementation WKVideoBrowseActionSlider
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        [self setThumbImage:[self getImageWithName:@"Conversation/VideoBrowser/ybib_circlePoint"] forState:UIControlStateNormal];
...
@interface WKVideoActionBar ()
@property (nonatomic, strong) UIButton *playButton;
@property (nonatomic, strong) UILabel *preTimeLabel;
@property (nonatomic, strong) UILabel *sufTimeLabel;
@property (nonatomic, strong) WKVideoBrowseActionSlider *slider;
@end

@implementation WKVideoActionBar {
    BOOL _dragging;
}
...
- (void)layoutSubviews {
    ...
    CGFloat imageWidth = [self getImageWithName:@"Conversation/VideoBrowser/ybib_play"].size.width;
...
- (UIButton *)playButton {
    if (!_playButton) {
        ...
        [_playButton setImage:[self getImageWithName:@"Conversation/VideoBrowser/ybib_play"] forState:UIControlStateNormal];
        [_playButton setImage:[self getImageWithName:@"Conversation/VideoBrowser/ybib_pause"] forState:UIControlStateSelected];
...
- (WKVideoBrowseActionSlider *)slider {
    if (!_slider) {
