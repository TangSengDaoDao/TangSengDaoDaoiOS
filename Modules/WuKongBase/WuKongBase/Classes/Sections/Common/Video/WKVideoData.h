...
/// 单击事件的处理闭包
typedef void (^YBIBVideoSingleTouchBlock)(WKVideoData *videoData);


/**
 图片数据类，承担配置数据和处理数据的责任
 */
@interface WKVideoData : NSObject <YBIBDataProtocol>
...
@property(nonatomic,strong,nullable) WKBaseTask *downloadTask; // 下载block
