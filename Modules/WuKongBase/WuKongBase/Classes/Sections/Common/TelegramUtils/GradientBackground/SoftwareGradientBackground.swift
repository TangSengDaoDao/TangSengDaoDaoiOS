...
@objc public final class GradientBackgroundNode: ASDisplayNode {
    ...
    @objc public static func generatePreview(size: CGSize, colors: [UIColor]) -> UIImage {
    ...
    @objc public static func generatePreview(size: CGSize, colors: [UIColor],offset:Int) -> UIImage {
        let positions = gatherPositions(shiftArray(array: GradientBackgroundNode.basePositions, offset: offset))
        return generateGradient(size: size, colors: colors, positions: positions)
    }

    private var colors: [UIColor]
    @objc public var phase: Int = 0

    @objc public let contentView: UIImageView
   ...
   @objc public init(colors: [UIColor]? = nil, useSharedAnimationPhase: Bool = false, adjustSaturation: Bool = true) {
   ...
   @objc public func updateLayout(size: CGSize) {
    ...
    @objc public func updateLayout(size: CGSize,extendAnimation:Bool) {
        self.updateLayout(size: size, transition: .animated(duration: 2, curve: .spring), extendAnimation: extendAnimation, backwards: false, completion: {})
     }
   ...
   @objc public func updateColors(colors: [UIColor]) {
        var updated = false
   ...
   @objc public func animateEvent() {
        self.animateEvent(transition: .animated(duration: 2, curve: .spring), extendAnimation: false, backwards: false, completion: {})
    }
}
