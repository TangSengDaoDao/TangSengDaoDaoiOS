...
public final class AnimatedNavigationStripeNode: ASDisplayNode {
    ...
    @objc public func updateWithPinned(index:Int, count:Int,panelHeight:CGFloat) {
        let animationTransition = ContainedViewLayoutTransition.animated(duration: 0.2, curve: .easeInOut)
        let lineFrame = CGRect(origin: CGPoint(x: 20.0, y: 0.0), size: CGSize(width: 2.0, height: panelHeight))
