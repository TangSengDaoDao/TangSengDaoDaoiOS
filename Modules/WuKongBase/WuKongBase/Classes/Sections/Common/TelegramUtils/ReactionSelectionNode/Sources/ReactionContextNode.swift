...
@objc public final class ReactionContextItem:NSObject {
    ...
    public let appearAnimation: WuKongReactionFile
    public let stillAnimation: WuKongReactionFile
    public let listAnimation: WuKongReactionFile
    public let largeListAnimation: WuKongReactionFile
    public let applicationAnimation: WuKongReactionFile
    public let largeApplicationAnimation: WuKongReactionFile
...
public final class ReactionContextNode: ASDisplayNode, UIScrollViewDelegate {
    ...
    public func animateOutToReaction(value: String, targetView: UIView, hideNode: Bool, animateTargetContainer: UIView?, addStandaloneReactionAnimation: ((StandaloneReactionAnimation) -> Void)?, completion: @escaping () -> Void) {
        ...
        let additionalAnimation: WuKongReactionFile
        if self.didTriggerExpandedReaction {
    ...
    @objc private func longPressGesture(_ recognizer: UILongPressGestureRecognizer) {
        ...
        case .began:
            ...
            if let itemNode = self.reactionItemNode(at: point) {
                ...
                self.longPressTimer = Timer(timeout: longPressDuration, repeat: false, completion: { [weak self] in
                    guard let strongSelf = self else {
                        return
                    }
