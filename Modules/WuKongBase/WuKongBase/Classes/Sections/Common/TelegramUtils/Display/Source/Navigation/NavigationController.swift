...
@objc open class NavigationController: UINavigationController, ContainableController, UIGestureRecognizerDelegate {
   ...
   @objc public override init(rootViewController: UIViewController) {
       self.mode = .single
       self.theme = NavigationControllerTheme(statusBar: .white, navigationBar: NavigationBarTheme(buttonColor: .red, disabledButtonColor: .red, primaryTextColor: .red, backgroundColor: .red, enableBackgroundBlur: false, separatorColor: .red, badgeBackgroundColor: .red, badgeStrokeColor: .red, badgeTextColor: .red), emptyAreaColor: .red)
