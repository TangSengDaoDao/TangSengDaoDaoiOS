...
@objc open class ContextControllerSourceNode: ContextReferenceContentNode {
    ...
    @objc public var activated: ((ContextGesture, CGPoint) -> Void)?
    ...
    @objc public func targetNodeForActivationProgressContentRectForOC(rect:CGRect) {
        self.targetNodeForActivationProgressContentRect = rect
    }
