...
IB_DESIGNABLE @interface WKCheckBox : UIControl <CAAnimationDelegate>
#else
IB_DESIGNABLE @interface WKCheckBox : UIControl
#endif
...
* @discussion The delegate must adopt the \p WKCheckBoxDelegate protocol. The delegate is not retained.
 */
@property (nonatomic, weak) IBOutlet id <WKCheckBoxDelegate> delegate;

/** This property allows you to retrieve and set (without animation) a value determining whether the WKCheckBox object is On or Off.
  * Default to NO.
 */
 ...
 */
@property (strong, nonatomic, nullable, readonly) WKCheckBoxGroup *group;
...
/** The WKCheckBoxDelegate protocol. Used to receive life cycle events.
 */
@protocol WKCheckBoxDelegate <NSObject>
 ...
 * @param checkBox The WKCheckBox instance that has been tapped.
 */
 ...
 * @param checkBox The WKCheckBox instance that was animated.
 */
- (void)animationDidStopForCheckBox:(WKCheckBox *)checkBox;
