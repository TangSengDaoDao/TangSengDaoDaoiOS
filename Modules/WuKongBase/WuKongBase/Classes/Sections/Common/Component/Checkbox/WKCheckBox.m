...
/** The WKAnimationManager object used to generate animations.
 */
@property (strong, nonatomic) WKAnimationManager *animationManager;

/** The WKPathManager object used to generate paths.
 */
@property (strong, nonatomic) WKPathManager *pathManager;
...
- (void)initPathManager {
    _pathManager = [WKPathManager new];
...
- (void)initAnimationManager {
    _animationManager = [[WKAnimationManager alloc] initWithAnimationDuration:_animationDuration];
}
