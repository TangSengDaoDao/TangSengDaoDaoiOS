...
/** Animation object used by WKCheckBox to generate animations.
 */
@interface WKAnimationManager : NSObject

/** The duration of the animation created by the WKAnimationManager object.
 */
@property (nonatomic) CGFloat animationDuration;

/** Designated initializer.
 * @param animationDuration The duration of the animations created with the WKAnimationManager object.
 * @return Returns the a fully initialized WKAnimationManager object.
 */
