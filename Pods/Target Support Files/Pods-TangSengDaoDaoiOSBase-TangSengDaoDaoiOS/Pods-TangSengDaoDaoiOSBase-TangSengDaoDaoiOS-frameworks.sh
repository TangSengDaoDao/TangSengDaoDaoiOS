...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Aspects-framework/Aspects.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ReactiveObjC-framework/ReactiveObjC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive-framework/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Socket.IO-Client-Swift-framework/SocketIO.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SocketRocket-framework/SocketRocket.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Starscream-framework/Starscream.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongBase/WuKongBase.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongContacts/WuKongContacts.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongDataSource/WuKongDataSource.framework"
  install_framework "${PODS_ROOT}/../Modules/WuKongIMiOSSDK-Framework/ios/WuKongIMSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongLogin/WuKongLogin.framework"
